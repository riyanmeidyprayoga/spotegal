...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $data = $_POST['id_tempat'];
    $sql = mysqli_query($connect, "SELECT * FROM tb_spot, tb_tempat 
WHERE tb_spot.id_tempat = tb_tempat.id_tempat
AND tb_tempat.id_tempat = '$data' AND tb_spot.deleted_at is NULL");
